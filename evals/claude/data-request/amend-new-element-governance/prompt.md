---
description: "A column that is not already surfaced is engineer-required and a new data element for governance"
...
The researcher emailed asking for the patient's discharge destination as an extra column. It
is in `ENCOUNTER.DISCH_DISPOSITION_CD`. Can we just add it to the extract? Classify it and tell
