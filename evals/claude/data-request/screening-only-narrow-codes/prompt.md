...
Triage ENQ1213 (rdl-service-desk/service-desk#76, approval SSAQHTS-43408); triage only. Tell me which output fields and diagnosis codes the draft should use. This session has no shell access; the evidence is below.

Intake form (SSAQHTS-43408 issue #1, 2026-08-02):
...
rdl-service-desk/service-desk#76 comment, 2026-08-20 (governance): "Approved for a screening log only: URN and the eligibility date. Contact details, demographics and pathology are not approved at this stage; a separate application is needed."
