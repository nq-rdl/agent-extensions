---
name: diagnose
description: 'Use when the user reports a bug, test failure, or unexpected behavior
  and wants it systematically diagnosed and fixed. Follows a four-phase methodology:
  assess, investigate, resolve, and quality-assure.'
license: MIT
metadata:
