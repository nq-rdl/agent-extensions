...
description: Bridge spec-kit tasks.md and plan.md into a feature-specific Superpowers
  SDD plan, then hand completed implementation to branch finishing.
compatibility: Bash 3.2+, awk, git; spec-kit T-number checkbox tasks; Superpowers
  task-brief with Task N headings (verify installed helper before use)
---
