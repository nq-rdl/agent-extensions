...
description: Discover plugins for a repository during Claude Code setup. Compare live
  team marketplace catalogs with the project stack and return ranked suggestions.
  Research only; do not install plugins or edit settings.
license: MIT
metadata:
