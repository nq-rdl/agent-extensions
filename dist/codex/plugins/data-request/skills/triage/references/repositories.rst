...
declare scaffold, scope or branch work missing. Observed on a September 2026
multi-enquiry triage; the identifiers below are fictional examples. Re-check
...
* Child repositories are named by approval ID (``THHSAQUIRE-9903``,
  ``SSAQHTS-99001``), not by enquiry number. A link to
  ``rdl-service-desk/THHSRDLENQ-9003`` is stale or invented: report it.
...
* Approval IDs drift in formatting (``THHSAQUIRE9903`` versus
  ``THHSAQUIRE-9903``). Normalise to the hyphenated form for lookup, and keep the
