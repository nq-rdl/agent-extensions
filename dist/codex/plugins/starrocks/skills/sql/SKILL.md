...
name: sql
license: CC-BY-4.0
description: StarRocks analytical data warehouse skill. Use when writing or reviewing
  StarRocks SQL, designing tables, choosing partition/bucket strategies, loading or
  unloading data, creating materialized views, tuning queries, or working with external
  catalogs (Hive, Iceberg, Hudi, Delta Lake). Covers DBA and data architect concerns
