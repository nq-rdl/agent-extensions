---
name: review
description: Review and create safer Terraform IaC changes with emphasis on state
  safety, least privilege, module patterns, drift detection, and plan/apply discipline.
  Use this skill for auditing existing configurations or approving infrastructure
