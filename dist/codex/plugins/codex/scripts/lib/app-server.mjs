...
const NATIVE_MANIFEST_URL = new URL("../../.codex-plugin/plugin.json", import.meta.url);
const NATIVE_HOST = fs.existsSync(NATIVE_MANIFEST_URL);
const PLUGIN_MANIFEST_URL = NATIVE_HOST ? NATIVE_MANIFEST_URL : new URL("../../.claude-plugin/plugin.json", import.meta.url);
...
const DEFAULT_CLIENT_INFO = {
  title: "Codex Plugin",
  name: NATIVE_HOST ? "Codex" : "Claude Code",
