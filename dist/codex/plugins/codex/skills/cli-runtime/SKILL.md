...
name: cli-runtime
license: Apache-2.0
description: Internal helper contract for calling the codex-companion runtime from
  Claude Code (Codex CLI 0.144.6)
metadata:
...
Primary helper:
- `node "${PLUGIN_ROOT}/scripts/codex-companion.mjs" task "<raw arguments>"`
