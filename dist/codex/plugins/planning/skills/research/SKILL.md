---
name: research
description: Use when asked to validate a technical spike document through exhaustive,
  recursive research; it mines documentation, analyzes code patterns, runs experiments
  with permission, and continuously updates the spike with structured findings.
license: MIT
metadata:
