...
description: Use when the user wants a security review of code, configurations, or
  architectural patterns. Identifies vulnerabilities with severity ratings and provides
