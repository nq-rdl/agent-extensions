---
name: pr-comments
description: Review all comments on an existing GitHub PR, address justified feedback,
  commit and push fixes to that same PR, and reply to and resolve handled review threads.
  Use when asked to handle PR feedback or review comments.
disable-model-invocation: true
license: CC-BY-4.0
compatibility: Git; authenticated GitHub CLI 2.97.0 command surface; GitHub REST API
  2022-11-28 and GraphQL v4.
metadata:
