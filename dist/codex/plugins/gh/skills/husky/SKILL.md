...
name: husky
license: CC-BY-4.0
description: Manage Git hooks with husky v9. Use when the user asks about git hooks
  setup, pre-commit hooks, commit-msg hooks, husky configuration, the prepare script,
  or CI integration for git hooks. Trigger on mentions of 'husky', '.husky/', 'prepare
  script', or git hook lifecycle management.
compatibility: Requires Node.js runtime and npm
metadata:
