...
name: actions-go
license: CC-BY-4.0
description: GitHub Actions CI/CD for Go projects. Use when writing or reviewing GitHub
  Actions workflows that build, test, lint, or release Go code — including actions/setup-go
  configuration, Go version matrix, dependency caching, go.mod/go.work version files,
  artifact uploads, and monorepo cache strategies. Also trigger when the user asks
  about CI for Go, GitHub Actions Go templates, or how to test Go on multiple versions
  in CI.
metadata:
