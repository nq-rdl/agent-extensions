---
name: configure-repo
description: Use when asked to bootstrap, configure, or audit a GitHub repository's
  engineering conventions — git hooks, changelog, conventional commits, CI/CD workflows,
  PR/release flow, and repo-level settings (branch protection, CODEOWNERS, security).
  It surveys the repo, reports config gaps with severity, and applies fixes by delegating
  to the gh plugin's skills.
license: MIT
metadata:
