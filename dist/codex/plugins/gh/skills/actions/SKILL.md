...
description: GitHub Actions specialist focused on secure CI/CD workflows, action pinning
  to full commit SHAs, OIDC authentication, least-privilege permissions, and supply-chain
  security. Delegate workflow authoring and security hardening with this skill.
license: MIT
metadata:
