...
license: CC-BY-4.0
description: Provides guidance on writing commit messages using the Conventional Commits
  specification. Trigger this skill when writing commit messages, generating changelogs,
  or when the user asks about commit message formatting, conventional commits, semantic
  versioning based on commits, or needs to categorize a change (e.g., feat vs fix
  vs chore).
metadata:
