...
failed Prepare or Finalize run are in [`AGENTS.md`](AGENTS.md) under **"Release"**. The
[release runbook](docs/releasing.md) is the step-by-step checklist: cutting a release, recovering
a partial failure or a late changie fragment, and rolling back a bad release.
