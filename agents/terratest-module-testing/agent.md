...
description: >-
  ...
  CI-safe patterns, staged tests, and negative-path validation. Use this agent
  when creating or improving test coverage for Terraform modules.
license: MIT
tools:
  - Read
  - Write
...
pin (gpt-5); normalized tool names; retained methodology, guidelines, and checklists
verbatim.
-->
