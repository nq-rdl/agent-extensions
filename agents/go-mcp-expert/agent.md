...
name: go-mcp-expert
description: >-
  Delegate to this agent when authoring or reviewing Go MCP servers; it applies
  official github.com/modelcontextprotocol/go-sdk patterns, type-safe structs,
  context handling, and idiomatic Go conventions throughout.
license: MIT
tools:
  - Read
  - Write
