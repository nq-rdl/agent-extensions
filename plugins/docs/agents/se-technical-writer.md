...
description: >-
  Delegate to this agent for technical writing tasks — developer docs, blog
  posts, tutorials, ADRs, and user guides — it adapts voice, structure, and
  depth to audience and content type.
license: MIT
tools:
  - Read
  - Write
