...
description: >-
  Review and create safer Terraform IaC changes with emphasis on state safety,
  least privilege, module patterns, drift detection, and plan/apply discipline.
  Use this agent for auditing existing configurations or approving infrastructure
...
original. Conversion: stripped VS Code-specific tool namespace; normalized tool names;
retained methodology, checklists, and body prose verbatim.
-->
