...
description: >-
  Use when the user wants a security review of code, configurations, or
  architectural patterns. Identifies vulnerabilities with severity ratings and
  provides specific, implementable fixes.
license: MIT
tools:
  - Read
  - Edit
...
openSimpleBrowser); normalized `$ARGUMENTS` / tool invocation prose; retained
methodology and checklists verbatim.
-->
