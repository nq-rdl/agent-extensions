...
name: doublecheck
description: >-
  Fact-check AI-generated text: extract claims, find source links, flag risks. Produces citations and risk flags for the user to judge — never renders a verdict itself.
license: MIT
tools:
  - Read
  - Grep
...
color: orange
metadata:
  upstream: https://github.com/github/awesome-copilot/blob/main/agents/doublecheck.agent.md
