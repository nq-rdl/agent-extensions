...
description: >-
  Delegate to this agent to audit code for bias, accessibility barriers, privacy violations, and discriminatory design, ensuring AI-driven systems work equitably for all users. Applies responsible-AI guardrails and raises deployment blockers before code ships.
license: MIT
tools:
  - Read
  - Grep
...
color: green
metadata:
  upstream: https://github.com/github/awesome-copilot/blob/main/agents/se-responsible-ai-code.agent.md
