#!/usr/bin/env bash
# Shared helpers for the sql-code plugin scripts (sourced by sqlreview.sh, not executed).
...
SR_DIR=".sqlreview"
SR_SETUP_HINT="Run /sql-code:setup to initialise the project (creates $SR_DIR/ with config.json and templates/)."
