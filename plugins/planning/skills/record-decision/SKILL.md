---
description: Use when the user wants to record an architectural decision (ADR) for a change or tradeoff they are making. Gathers context, assigns sequential numbering, and produces a structured markdown ADR file.
license: MIT
metadata:
