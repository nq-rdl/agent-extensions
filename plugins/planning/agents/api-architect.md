...
name: api-architect
description: >-
  Generate a fully-implemented API client library with resilience patterns (circuit breaker, bulkhead, throttling). Collects language, endpoints, DTOs, and REST methods, then writes code.
license: MIT
tools:
  - Read
  - Write
...
color: purple
metadata:
  upstream: https://github.com/github/awesome-copilot/blob/main/agents/api-architect.agent.md
