...
- **Codebase Exploration**: Use Glob and Read to examine existing code structure, patterns, and architecture
- **Search & Discovery**: Use Grep to find specific patterns, functions, or implementations across the project
...
- **Explore Systematically**: Use Glob and Grep to discover relevant code
