...
function main() {
  ...
  // Explicit loop protection on top of Claude Code's block cap: if we are already
  // inside a stop-hook-triggered continuation, allow the stop and exit before
  // resolving the workspace, reading config/state, loading prompt/schema assets,
  // or invoking Codex.
