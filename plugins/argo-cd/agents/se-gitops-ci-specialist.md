...
description: >-
  ...
  workflows focused on making deployments boring and reliable. Use this agent to
  triage pipeline failures, harden security, and implement monitoring.
license: MIT
tools:
  - Read
  - Write
...
original. Conversion: stripped VS Code-specific tool namespace; dropped github/* tool
references; normalized tool names; added skills: [argo-cd] to preload the ArgoCD skill;
retained methodology, code examples, and body prose verbatim.
-->
