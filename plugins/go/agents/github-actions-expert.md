...
description: >-
  GitHub Actions specialist focused on secure CI/CD workflows, action pinning to
  full commit SHAs, OIDC authentication, least-privilege permissions, and
  supply-chain security. Delegate workflow authoring and security hardening to
  this agent.
license: MIT
tools:
  - Read
...
original. Conversion: stripped VS Code-specific tool namespace; dropped github/*
tool references; normalized tool names; retained methodology, checklists, and body
prose verbatim.
-->
