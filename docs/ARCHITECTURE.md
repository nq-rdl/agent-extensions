...
Workflow results and enforced merge requirements are separate. On **2026-09-23**,
the `main` protection API returned `required_status_checks: null`, and the branch rules
