...
| [`data-request`](#data-request) | Yes | Yes | Data Request — scope, map, draft, validate, fix and amend request SQL and Python with shared RDL guardrails and human-confirmed review handoffs |
...
Data Request — scope, map, draft, validate, fix and amend request SQL and Python with shared RDL guardrails and human-confirmed review handoffs.
