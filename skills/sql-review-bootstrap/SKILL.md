...
description: >-
  ...
  on an existing scope walks through what changed. Use at the start of the SQL Review workflow,
  after /sql-review:setup and before /sql-review:analyse.
...
# SQL Review — bootstrap (Data Engineer)
