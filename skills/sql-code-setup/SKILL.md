...
license: CC-BY-4.0
description: >-
  Initialise project scope and review records for the SQL Code workflow: create the .sqlreview/ directory with
  ...
  once per project before /sql-code:bootstrap, :analyse or :explain, or whenever one of them
...
Custom answers: after `init`, show the two role names and confirm them with AskUserQuestion
